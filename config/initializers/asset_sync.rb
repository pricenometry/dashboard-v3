AssetSync.configure do |config|
  ...
  config.aws_access_key_id = Rails.configuration.config[:fog][:aws_access_key_id]
  config.aws_secret_access_key = Rails.configuration.config[:fog][:aws_secret_access_key]
  # To use AWS reduced redundancy storage.
  config.aws_reduced_redundancy = true
  config.fog_directory = 'production/assets'
